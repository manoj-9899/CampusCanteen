...
export function InventoryItemCard({
  ...
  onSetLowStockThreshold: (threshold: number) => void | Promise<void>;
}) {
  return (
    <Card>
        ...
        <div className="flex items-start justify-between gap-3">
          ...
          <label className="flex shrink-0 cursor-pointer flex-col items-center gap-1">
            ...
            <span className="relative inline-flex h-6 w-11 items-center">
              ...
              />
              <span className="h-6 w-11 rounded-full bg-red-400 transition peer-checked:bg-success peer-disabled:opacity-50 after:absolute after:left-0.5 after:top-0.5 after:h-5 after:w-5 after:rounded-full after:bg-white after:transition peer-checked:after:translate-x-5" />
            </span>
          </label>
        </div>
